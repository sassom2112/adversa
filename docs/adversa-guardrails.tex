...
\begin{tikzpicture}[
    ...
    \node (triage) [layer=blue!8, draw=blue!70!black] {
        ...
        \footnotesize
        Pass 1: $\sim$25 deterministic SIFT commands · ASL detection scoring \\[1pt]
    ...
    \node (auditor) [layer=orange!10, draw=orange!80!black, below=0.8cm of ind] {
        ...
        \footnotesize
        \texttt{asyncio.gather} · 3 verification rounds $\times$ 2 independent tool calls per technique \\[1pt]
    ...
    \node (G1) [layer=red!8, draw=red!70!black, below=0.5cm of sep] {
        ...
        \footnotesize
        26 hard-blocked strings: \texttt{shred}, \texttt{mkfs}, \texttt{fdisk}, \texttt{wget},
...
\end{tikzpicture}
\end{adjustbox}
\caption{ADVERSA Guardrails — Anti-Hallucination Trust Chain \& MCP Security Boundary}
